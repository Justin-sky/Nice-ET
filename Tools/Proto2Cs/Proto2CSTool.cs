...
namespace NiceET
{
    public static class Proto2CSTool
    {
        private const string protoPath = "../protos";
        private const string serverMessagePath = "../csharp_out/";
        ...
        {
            msgOpcode.Clear();
            Proto2CS("NiceET", "InnerMessage.proto", serverMessagePath, "InnerOpcode", 1000);
            GenerateOpcode("NiceET", "InnerOpcode", serverMessagePath);
        }

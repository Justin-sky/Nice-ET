...
// source: protos/OuterMessage.proto
...
namespace NiceET {
  ...
  public partial class G2C_EnterMap : pb::IMessage {
    ...
    private static readonly pb::FieldCodec<global::NiceET.UnitInfo> _repeated_units_codec
        = pb::FieldCodec.ForMessage(18, global::NiceET.UnitInfo.Parser);
    private pbc::RepeatedField<global::NiceET.UnitInfo> units_ = new pbc::RepeatedField<global::NiceET.UnitInfo>();
    /// <summary>
    /// 所有的unit
    /// </summary>
    public pbc::RepeatedField<global::NiceET.UnitInfo> Units {
      get { return units_; }
      set { units_ = value; }
    }
  ...
  public partial class M2C_CreateUnits : pb::IMessage {
    ...
    private static readonly pb::FieldCodec<global::NiceET.UnitInfo> _repeated_units_codec
        = pb::FieldCodec.ForMessage(10, global::NiceET.UnitInfo.Parser);
    private pbc::RepeatedField<global::NiceET.UnitInfo> units_ = new pbc::RepeatedField<global::NiceET.UnitInfo>();
    public pbc::RepeatedField<global::NiceET.UnitInfo> Units {
      get { return units_; }
      set { units_ = value; }
  ...
  public partial class G2C_PlayerInfo : pb::IMessage {
    ...
    private global::NiceET.PlayerInfo playerInfo_;
    public global::NiceET.PlayerInfo PlayerInfo {
    ...
    private static readonly pb::FieldCodec<global::NiceET.PlayerInfo> _repeated_playerInfos_codec
        = pb::FieldCodec.ForMessage(18, global::NiceET.PlayerInfo.Parser);
    private pbc::RepeatedField<global::NiceET.PlayerInfo> playerInfos_ = new pbc::RepeatedField<global::NiceET.PlayerInfo>();
    public pbc::RepeatedField<global::NiceET.PlayerInfo> PlayerInfos {
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 10: {
            if (playerInfo_ == null) {
              playerInfo_ = new global::NiceET.PlayerInfo();
            }
